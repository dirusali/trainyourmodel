...
app_name = 'portal'
from .views import HomeView, plottings, upload_csv, FuncionaView, ContactoView, CondicionesView, PrivacidadView, subscribe, successView, contacto
...
urlpatterns = [
    url(r'^$', HomeView.as_view(), name='home'),  
        ...
        url(r'^plots/$', plottings, name='plottings'),
